...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "ATrustSSOEnabled":
			system_setting.ATrustSSOEnabled = boolValue
		case "ATrustSSOAutoRegister":
			system_setting.ATrustSSOAutoRegister = boolValue
	...
	case "ATrustSSOAppSecret":
		system_setting.ATrustSSOAppSecret = value
	case "ATrustProxyIPs":
	...
	case "ATrustSyncPaths":
		system_setting.ATrustSyncPaths = value
	case "ATrustSyncEmployeeIds":
		system_setting.ATrustSyncEmployeeIds = value
	...
	case "GuideAPIBase":
		system_setting.GuideAPIBase = value
	case "WorkerUrl":
